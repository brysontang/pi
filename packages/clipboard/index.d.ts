...
export declare function callThreadsafeFunction(callback: (error: Error | null, argument: number) => void): void;
...
export declare function setImageBase64(base64String: string): Promise<void>;
