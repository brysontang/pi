...
required_paths=(
    ...
    "packages/clipboard/Cargo.lock"
    "packages/clipboard/Cargo.toml"
    "packages/clipboard/index.cjs"
    "packages/clipboard/native/darwin/prebuilds/darwin-arm64/clipboard.darwin-arm64.node"
    "packages/clipboard/native/darwin/prebuilds/darwin-x64/clipboard.darwin-x64.node"
    "packages/clipboard/native/linux/prebuilds/linux-arm64-gnu/clipboard.linux-arm64-gnu.node"
    "packages/clipboard/native/linux/prebuilds/linux-arm64-musl/clipboard.linux-arm64-musl.node"
    "packages/clipboard/native/linux/prebuilds/linux-riscv64-gnu/clipboard.linux-riscv64-gnu.node"
    "packages/clipboard/native/linux/prebuilds/linux-x64-gnu/clipboard.linux-x64-gnu.node"
    "packages/clipboard/native/linux/prebuilds/linux-x64-musl/clipboard.linux-x64-musl.node"
    "packages/clipboard/native/win32/prebuilds/win32-arm64-msvc/clipboard.win32-arm64-msvc.node"
    "packages/clipboard/native/win32/prebuilds/win32-x64-msvc/clipboard.win32-x64-msvc.node"
